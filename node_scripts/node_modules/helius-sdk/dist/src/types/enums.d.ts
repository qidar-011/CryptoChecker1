...
export declare enum AccountWebhookEncoding {
...
export declare const NftEventTypes: TransactionType[];
...
export declare enum AssetSortDirection {
    Asc = "asc",
    Desc = "desc"
}
...
export declare enum MintApiAuthority {
...
export declare enum UiTransactionEncoding {
    Binary = "Binary",
    Base64 = "Base64",
    Base58 = "Base58",
    Json = "Json",
...
export declare const JITO_API_URLS: Record<JitoRegion, string>;
